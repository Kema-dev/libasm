...
/*   Updated: 2021/01/21 11:12:09 by jjourdan         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
{
	ssize_t	i;
	char	*args1[5] = {"", "1", "12345", "12345\07890", ""};

	i = -1;
	printf("\n\nTesting strdup:\n\n");
	while (++i < 5)
	{
		printf("Test with \"%s\" and \"%s\" : ", args1[i]);
		free(param->str_o);
		free(param->str_u);
